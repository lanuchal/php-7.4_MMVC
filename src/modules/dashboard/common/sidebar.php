      ...
      <nav x-data="sidebar"
          ...
          <div class="h-full bg-white dark:bg-[#0e1726]">
              <div class="flex items-center justify-between px-4 py-3">
                  <a href="sale" class="main-logo flex shrink-0 items-center">
              ...
              <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold"
                  x-data="{ activeDropdown: '<?= $controller == "sale" || $controller == "analytics" || $controller == "finance" || $controller == "crypto" ? "dashboard" : "null" ?>' }">
                  <li class="menu nav-item">
                      ...
                      <ul x-cloak x-show="activeDropdown === 'dashboard'" x-collapse
                          ...
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="sale">Sales</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "analytics" ? "active" : "") ?>" href="analytics">Analytics</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "finance" ? "active" : "") ?>" href="finance">Finance</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "crypto" ? "active" : "") ?>" href="crypto">Crypto</a>
                          </li>
                      </ul>
                  </li>
                  ...
                  <li class="nav-item">
                      <ul>
                          <li class="nav-item">
                              <a href="apps-chat" class="group <?= ($controller === "apps-chat" ? "active" : "") ?>">
                                  <div class="flex items-center">
                                      <svg class="shrink-0 group-hover:!text-primary" width="20" height="20"
                                          viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <li class="nav-item">
                              <a href="apps-mailbox" class="group <?= ($controller === "apps-mailbox" ? "active" : "") ?>">
                                  <div class="flex items-center">
                                      <svg class="shrink-0 group-hover:!text-primary" width="20" height="20"
                                          viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path
                          ...
                          <li class="nav-item">
                              <a href="apps-todolist" class="group <?= ($controller === "apps-todolist" ? "active" : "") ?>">
                                  <div class="flex items-center">
                                      <svg class="shrink-0 group-hover:!text-primary" width="20" height="20"
                                          viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path opacity="0.5"
                          ...
                          <li class="nav-item">
                              <a href="apps-notes" class="group <?= ($controller === "apps-notes" ? "active" : "") ?>">
                                  <div class="flex items-center">
                                      <svg class="shrink-0 group-hover:!text-primary" width="20" height="20"
                                          viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path opacity="0.5"
                          ...
                          <li class="nav-item">
                              <a href="apps-scrumboard" class="group <?= ($controller === "apps-scrumboard" ? "active" : "") ?>">
                                  <div class="flex items-center">
                                      <svg class="shrink-0 group-hover:!text-primary" width="20" height="20"
                                          viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path opacity="0.5"
                          ...
                          <li class="nav-item">
                              <a href="apps-contacts" class="group <?= ($controller === "apps-contacts" ? "active" : "") ?>">
                                  <div class="flex items-center">
                                      <svg class="shrink-0 group-hover:!text-primary" width="20" height="20"
                                          viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path opacity="0.5"
                          ...
                          <li class="menu nav-item">
                              ...
                              <ul x-cloak x-show="activeDropdown === 'invoice'" x-collapse
                                  class="sub-menu text-gray-500">
                                  <li>
                                      <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="apps-invoice-list">List</a>
                                  </li>
                                  <li>
                                      <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="apps-invoice-preview">Preview</a>
                                  </li>
                                  <li>
                                      <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="apps-invoice-add">Add</a>
                                  </li>
                                  <li>
                                      <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="apps-invoice-edit">Edit</a>
                                  </li>
                              </ul>
                          </li>
                          <li class="nav-item">
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="apps-calendar" class="group">
                                  <div class="flex items-center">
                                      <svg class="shrink-0 group-hover:!text-primary" width="20" height="20"
                                          viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path
                  ...
                  <li class="menu nav-item">
                      ...
                      <ul x-cloak x-show="activeDropdown === 'components'" x-collapse
                          class="sub-menu text-gray-500">
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="components-tabs">Tabs</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="components-accordions">Accordions</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="components-modals">Modals</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="components-cards">Cards</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="components-carousel">Carousel</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="components-countdown">Countdown</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="components-counter">Counter</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="components-sweetalert">Sweet Alerts</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="components-timeline">Timeline</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="components-notifications">Notifications</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="components-media-object">Media Object</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="components-list-group">List Group</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="components-pricing-table">Pricing Tables</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="components-lightbox">Lightbox</a>
                          </li>
                      </ul>
                  </li>
                  ...
                  <li class="menu nav-item">
                      ...
                      <ul x-cloak x-show="activeDropdown === 'elements'" x-collapse
                          class="sub-menu text-gray-500">
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="elements-alerts">Alerts</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="elements-avatar">Avatar</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="elements-badges">Badges</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="elements-breadcrumbs">Breadcrumbs</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="elements-buttons">Buttons</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="elements-buttons-group">Button Groups</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="elements-color-library">Color Library</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="elements-dropdown">Dropdown</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="elements-infobox">Infobox</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="elements-jumbotron">Jumbotron</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="elements-loader">Loader</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="elements-pagination">Pagination</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="elements-popovers">Popovers</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="elements-progress-bar">Progress Bar</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="elements-search">Search</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="elements-tooltips">Tooltips</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="elements-treeview">Treeview</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="elements-typography">Typography</a>
                          </li>
                      </ul>
                  </li>

                  <li class="menu nav-item">
                      <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="charts" class="nav-link group">
                          <div class="flex items-center">
                              <svg class="shrink-0 group-hover:!text-primary" width="20" height="20"
                                  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path opacity="0.5"
                  ...
                  <li class="menu nav-item">
                      <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="widgets" class="nav-link group">
                          <div class="flex items-center">
                              <svg class="shrink-0 group-hover:!text-primary" width="20" height="20"
                                  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path opacity="0.5"
                  ...
                  <li class="menu nav-item">
                      <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="font-icons" class="nav-link group">
                          <div class="flex items-center">
                              <svg class="shrink-0 group-hover:!text-primary" width="20" height="20"
                                  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path opacity="0.5"
                  ...
                  <li class="menu nav-item">
                      <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="dragndrop" class="nav-link group">
                          <div class="flex items-center">
                              <svg class="shrink-0 group-hover:!text-primary" width="20" height="20"
                                  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path opacity="0.5"
                  ...
                  <li class="menu nav-item">
                      <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="tables" class="nav-link group">
                          <div class="flex items-center">
                              <svg class="shrink-0 group-hover:!text-primary" width="20" height="20"
                                  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path opacity="0.5"
                  ...
                  <li class="menu nav-item">
                      ...
                      <ul x-cloak x-show="activeDropdown === 'datatables'" x-collapse
                          class="sub-menu text-gray-500">
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="datatables-basic">Basic</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="datatables-advanced">Advanced</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="datatables-skin">Skin</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="datatables-order-sorting">Order Sorting</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="datatables-multi-column">Multi Column</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="datatables-multiple-tables">Multiple Tables</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="datatables-alt-pagination">Alt. Pagination</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="datatables-checkbox">Checkbox</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="datatables-range-search">Range Search</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="datatables-export">Export</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="datatables-sticky-header">Sticky Header</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="datatables-clone-header">Clone Header</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="datatables-column-chooser">Column Chooser</a>
                          </li>
                      </ul>
                  </li>
                  ...
                  <li class="menu nav-item">
                      ...
                      <ul x-cloak x-show="activeDropdown === 'forms'" x-collapse class="sub-menu text-gray-500">
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="forms-basic">Basic</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="forms-input-group">Input Group</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="forms-layouts">Layouts</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="forms-validation">Validation</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="forms-input-mask">Input Mask</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="forms-select2">Select2</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="forms-touchspin">TouchSpin</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="forms-checkbox-radio">Checkbox & Radio</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="forms-switches">Switches</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="forms-wizards">Wizards</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="forms-file-upload">File Upload</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="forms-quill-editor">Quill Editor</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="forms-markdown-editor">Markdown Editor</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="forms-date-picker">Date & Range Picker</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="forms-clipboard">Clipboard</a>
                          </li>
                      </ul>
                  </li>
                  ...
                  <li class="menu nav-item">
                      ...
                      <ul x-cloak x-show="activeDropdown === 'users'" x-collapse class="sub-menu text-gray-500">
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="users-profile">Profile</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="users-account-settings">Account Settings</a>
                          </li>
                      </ul>
                  </li>
                  <li class="menu nav-item">
                      ...
                      <ul x-cloak x-show="activeDropdown === 'pages'" x-collapse class="sub-menu text-gray-500">
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="pages-knowledge-base">Knowledge Base</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="pages-contact-us-boxed" target="_blank">Contact Us Boxed</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="pages-contact-us-cover" target="_blank">Contact Us Cover</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="pages-faq">Faq</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="pages-coming-soon-boxed" target="_blank">Coming Soon Boxed</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="pages-coming-soon-cover" target="_blank">Coming Soon Cover</a>
                          </li>
                          <li x-data="{subActive:null}">
                              ...
                              <ul class="sub-menu text-gray-500 ltr:ml-2 rtl:mr-2" x-show="subActive === 'error'"
                                  x-collapse>
                                  <li>
                                      <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="pages-error404" target="_blank">404</a>
                                  </li>
                                  <li>
                                      <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="pages-error500" target="_blank">500</a>
                                  </li>
                                  <li>
                                      <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="pages-error503" target="_blank">503</a>
                                  </li>
                              </ul>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="pages-maintenence" target="_blank">Maintanence</a>
                          </li>
                      </ul>
                  </li>
                  <li class="menu nav-item">
                      ...
                      <ul x-cloak x-show="activeDropdown === 'authentication'" x-collapse
                          class="sub-menu text-gray-500">
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="auth-boxed-signin" target="_blank">Login Boxed</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="auth-boxed-signup" target="_blank">Register Boxed</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="auth-boxed-lockscreen" target="_blank">Unlock Boxed</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="auth-boxed-password-reset" target="_blank">Recover ID Boxed</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="auth-cover-login" target="_blank">Login Cover</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="auth-cover-register" target="_blank">Register Cover</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="auth-cover-lockscreen" target="_blank">Unlock Cover</a>
                          </li>
                          <li>
                              <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="auth-cover-password-reset" target="_blank">Recover ID Cover</a>
                          </li>
                      </ul>
                  </li>
                  ...
                  <li class="menu nav-item">
                      <a class="<?= ($controller === "sale" ? "active" : "") ?>" href="https://vristo.sbthemes.com" target="_blank" class="nav-link group">
                          <div class="flex items-center">
                              <svg class="shrink-0 group-hover:!text-primary" width="20" height="20"
                                  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path fill-rule="evenodd" clip-rule="evenodd"
