...
<body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased"
    ...
    <?php require_once  ROOT_PATH . "/modules/dashboard/common/loader.php" ?>

    <!-- scroll to top button -->

    <?php require_once  ROOT_PATH . "/modules/dashboard/common/scroll.php" ?>

    <!-- start theme customizer section -->

    <?php require_once  ROOT_PATH . "/modules/dashboard/common/customizer.php" ?>

    <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
        <!-- start sidebar section -->
        <?php require_once  ROOT_PATH . "/modules/dashboard/common/sidebar.php" ?>
        <!-- end sidebar section -->
        ...
        <div class="main-content flex min-h-screen flex-col">
            ...
            <?php require_once  ROOT_PATH . "/modules/dashboard/common/header.php" ?>
            <!-- end header section -->
